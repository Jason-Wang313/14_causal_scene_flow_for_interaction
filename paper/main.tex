...
\label{tab:main}
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_main_multidistractor.tex}}
\end{table}
...
\label{tab:misspec}
\resizebox{0.92\linewidth}{!}{\input{../results/full_scale/table_misspecification.tex}}
\end{table}
...
\label{tab:overlap}
\resizebox{0.86\linewidth}{!}{\input{../results/full_scale/table_overlap.tex}}
\end{table}
...
\label{tab:ego}
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_egomotion.tex}}
\end{table}
...
\label{tab:learned}
\resizebox{0.75\linewidth}{!}{\input{../results/full_scale/table_learned_noop.tex}}
\end{table}
...
\label{tab:metric}
\resizebox{\linewidth}{!}{\input{../results/full_scale/table_metric_mismatch.tex}}
\end{table}
...
\label{tab:ablation}
\resizebox{0.86\linewidth}{!}{\input{../results/full_scale/table_ablation.tex}}
\end{table}
